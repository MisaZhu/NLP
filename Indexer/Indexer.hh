...
class Indexer {
	...
	IndexerItem* doAnd(const IndexerItem* item0, const IndexerItem* item1);

	IndexerItem* doOr(const IndexerItem* item0, const IndexerItem* item1);

	void sort(const IndexerItem* item, vector<IDFreq>& ret);
